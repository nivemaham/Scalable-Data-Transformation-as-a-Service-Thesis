...
\subsubsection{Poor performance due to legacy architectural approaches }
...
% In summary, open data workers suffers from,
% \begin{itemize}
% \item lack of scalability of data cleaning solutions,
% \item non-interactive and bounded for technical users,
% \item no end-to-end solution to solve open data preparation
% \item longer responsive in iterative data cleaning over large volumes of data, that hinders interactivity
% \item and not available as a cloud-based solution that is always available, share-able and easy to access. 
% \end{itemize}
...
% \item and is available as a service
\end{itemize}
% that can be used , which both to process tabular data n graph that is scalable, interactive, responsive in real-time, and available as a service?
...
\end{enumerate}
% or remove graph n tabular mention end-to-end, mention in the evaluation that it met the req. 
